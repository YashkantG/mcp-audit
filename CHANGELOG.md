...
- **New rules may be added in a minor release.** This can surface new findings
  in an existing codebase, which is why `--fail-on`, `.mcpsentinel.toml`, and
...
- **Inline suppression comments**: `# mcp-sentinel: ignore[MCP102]` suppresses
  a specific rule on that line; a bare `# mcp-sentinel: ignore` suppresses all.
- **Project configuration** via `.mcpsentinel.toml`: repo-wide rule and path
...
[Unreleased]: https://github.com/YashkantG/mcp-sentinel/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/YashkantG/mcp-sentinel/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/YashkantG/mcp-sentinel/compare/v0.1.0...v0.2.0
[0.1.0]: https://github.com/YashkantG/mcp-sentinel/releases/tag/v0.1.0
